...
<img src="https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/goodreads.png" align="centre">

## Architecture 
![Pipeline Architecture](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/architecture.png)
...
Finally, copy the dag and plugin folder to EC2 inside airflow home directory. Also, checkout [Airflow Connection](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/Airflow_Connections.md) for setting up connection to EMR and Redshift from Airflow.
...
![Pipeline DAG](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/goodreads_dag.PNG)

DAG View:
![DAG View](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/DAG.PNG)

DAG Tree View:
![DAG Tree](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

DAG Gantt View: 
![DAG Gantt View](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/DAG_Gantt.PNG)
...
![Source Dataset Count](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/DatasetCount.PNG)


DAG Run Results:
![GoodReads DAG Run](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/DAG_tree_view.PNG)

Data Loaded to Warehouse:
![GoodReads Warehouse Count](https://github.com/devman-AI/python_etl_pipeline/blob/master/docs/images/WarehouseCount.PNG)
